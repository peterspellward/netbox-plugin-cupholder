"""
NetBox configuration for testing NetBox Cup Holder Plugin.
...
# Do not exempt view permissions — permission tests expect 403 without ObjectPermission.
# NetBox defaults EXEMPT_VIEW_PERMISSIONS to [] when unset.
